...
(function ($) {
  ...
  $.fn.navList = function () {
    ...
    $a.each(function () {
      ...
      b.push("<a " + 'class="link link-url depth-' + indent + '"' + (typeof target !== "undefined" && target != "" ? ' target="' + target + '"' : "") + (typeof href !== "undefined" && href != "" ? ' href="' + href + '"' : "") + ">" + '<span class="indent-' + indent + '"></span>' + $this.text() + "</a>");
    });
    return b.join("");
  };
  /**
