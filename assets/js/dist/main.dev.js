...
var onEnterViewPort = function onEnterViewPort(entries, observer) {
...
(function ($) {
  ...
  if (browser.os == "wp" && browser.osVersion < 10) $("#navButton, #navPanel, #page-wrapper").css("transition", "none"); // Header.
